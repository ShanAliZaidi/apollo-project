...
export type CompanyInfoQuery = (
  ...
  & { info?: Maybe<(
    { __typename?: 'Info' }
    & Pick<Info, 'name' | 'summary' | 'founded' | 'ceo' | 'valuation'>
  )> }
);
...
export type MissionsQuery = (
  ...
  & { mission?: Maybe<(
    { __typename?: 'Mission' }
    & Pick<Mission, 'mission_id' | 'manufacturers' | 'mission_name' | 'description' | 'website' | 'twitter' | 'wikipedia'>
  )> }
);
...
export type MissionsInfoQuery = (
  ...
  & { missions?: Maybe<Array<Maybe<(
    { __typename?: 'Mission' }
    & Pick<Mission, 'mission_id' | 'manufacturers' | 'mission_name'>
  )>>> }
);
